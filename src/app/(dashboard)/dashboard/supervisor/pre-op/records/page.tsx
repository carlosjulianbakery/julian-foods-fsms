...
function DeleteInspectionModal({
  ...
  const statusLabel = { PASS: "Pass", FAIL: "Fail", PASS_WITH_ISSUES: "Pass w/ Issues" }[ins.status];
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-md border border-gray-200 shadow-xl w-full max-w-md">
        ...
        <div className="flex items-start gap-3 px-6 pt-6 pb-4">
          ...
          <div>
            <h2 className="font-bold text-gray-900 font-garamond text-lg">Delete Pre-Op Inspection Record</h2>
        ...
        <div className="px-6 pb-4">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-md p-4 space-y-1.5 text-sm font-mono">
            <div className="flex gap-2">
              <span className="text-gray-400 w-28 shrink-0">Date</span>
              <span className="text-gray-800 font-semibold">{fmtDateUtil(ins.date)}</span>
            </div>
            <div className="flex gap-2">
              <span className="text-gray-400 w-28 shrink-0">Shift</span>
              <span className="text-gray-800">{ins.shift}</span>
            </div>
            <div className="flex gap-2">
              <span className="text-gray-400 w-28 shrink-0">Supervisor</span>
              <span className="text-gray-800">{ins.submittedBy.name}</span>
            </div>
            <div className="flex gap-2">
              <span className="text-gray-400 w-28 shrink-0">Overall Status</span>
              <span className="text-gray-800">{statusLabel}</span>
            </div>
          </div>
