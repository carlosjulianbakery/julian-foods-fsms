    ...
    fetch(`/api/supplier-management/materials/${params.id}`)
      ...
      .then((data) => {
        ...
        setForm({
          ...
          materialType: data.materialType ?? "raw",
          sourceProductId: data.sourceProductId ?? "",
          isTemperatureSensitive: data.isTemperatureSensitive ?? false,
          coaRequired: data.coaRequired ?? false,
          minimumStockQuantity: data.minimumStockQuantity != null ? String(data.minimumStockQuantity) : "",
          minimumStockUnit: data.minimumStockUnit ?? "",
        });
      })
